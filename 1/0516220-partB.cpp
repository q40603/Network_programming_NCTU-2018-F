...
int main(int argc, char *argv[]){
	...
	pthread_t *tid = new pthread_t[total_customer];
	pthread_attr_t *attr = new pthread_attr_t[total_customer];
	...
	for(int i = 0 ; i <= min_next_play_time.size() ; i++){
		printf("min_next_play_time = %d\n",*it);
	}
	for(int i = 0; i < total_customer; i++){
		//cout<<min_next_play_time[i]
